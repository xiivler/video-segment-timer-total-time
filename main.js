...
document.getElementById('60frameTimeParagraphTotal').style.display = "none";
...
function changeFPS() {
    if (document.getElementById('30FPS').checked) {
        ...
        document.getElementById('60frameTimeParagraphTotal').style.display = "block";
    } else {
        framerate = 60;
        document.getElementById('60frameTimeParagraph').style.display = "none";
        document.getElementById('60frameTimeParagraphTotal').style.display = "none";
...
function calculateTotal() {
    let seconds = Math.floor(totalTime / framerate);
    let frames = totalTime % framerate;

    let frameTime = String(seconds).padStart(2, '0') + ':' + String(frames).padStart(2, '0');
    document.getElementById('frameTimeTotal').value = frameTime;

    if (framerate != 60) {
        let frames60FPS = Math.round(frames / framerate * 60);
        let frameTime60FPS = String(seconds).padStart(2, '0') + ':' + String(frames60FPS).padStart(2, '0');
        document.getElementById('frameTime60FPSTotal').value = frameTime60FPS;
    }
    ...
    let msTime = String(hours).padStart(2, '0') + ':' + String(minutes).padStart(2, '0') + ':' + String(seconds).padStart(2, '0') + '.' + String(milliseconds).padStart(3, '0');
    document.getElementById('msTimeTotal').value = msTime;
}
